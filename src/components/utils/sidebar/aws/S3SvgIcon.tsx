  ...
  return (
    <div className="sidebar-aws-icon-div group">
      ...
      <svg viewBox="0 0 80 80" 
        ...
        <desc>Icon-Architecture/64/Arch_Amazon-Simple-Storage-Service_64</desc>
        <defs>
          <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="linearGradient-s3">
            <stop stopColor="#1B660F" offset="0%"></stop>
            <stop stopColor="#6CAE3E" offset="100%"></stop>
          </linearGradient>
        </defs>

        <g id="Icon-Architecture/64/Arch_Amazon-Simple-Storage-Service_64" stroke="none" strokeWidth="1"
          fill="none" fillRule="evenodd"
          className="fill-slate-600 hover:fill-[url(#linearGradient-s3)]">
